...
//                                 </ListItem>
//                             </Link>
//                             <Link href="/dashboard/admin/blogs/all-blogs">
//                                 <ListItem
//                                     disablePadding
//                                     sx={{
//                                         ...(pathname === "/dashboard/admin/blogs/all-blogs"
//                                             ? {
//                                                 borderRight: "3px solid #67d2f0",
//                                                 "& svg": {
//                                                     color: "#9de7fc",
...
import Toolbar from "@mui/material/Toolbar";
import Typography from "@mui/material/Typography";
import { Divider, List, ListItem, Stack, Collapse } from "@mui/material";
import Link from "next/link";
import { ListItemButton, ListItemText } from "@mui/material";
import { usePathname } from "next/navigation";
                                ...
                                <List component="div" disablePadding>
                                    ...
                                    <Link href="/dashboard/admin/blogs/add-blog">
                                        <ListItem
                                            disablePadding
                                            sx={{
                                                ...(pathname === "/dashboard/admin/blogs/add-blog"
                                                    ? {
                                                        borderRight: "3px solid #67d2f0",
                                                        "& svg": {
                                                            color: "#9de7fc",
